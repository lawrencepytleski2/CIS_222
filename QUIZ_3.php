...
<?php
    <form method="post" >
        ...
        <input type="text" name="action" value="add_email_subscriber" >
...
<?php
function multiplyAddNumbers(int $a, int $b, int $c) {
  return $a * $b + $c;
}
?>
...
<?php
function multiplyAddNumbers(int $i1, int $i2, int $i3) {
  return $i1 * $i2+ $i3;
}
echo multiplyAddNumbers(7, 13, 17);
var_dump( $i1 * $i2+ $i3 );
echo "The answer is 37!!<br><br>";
